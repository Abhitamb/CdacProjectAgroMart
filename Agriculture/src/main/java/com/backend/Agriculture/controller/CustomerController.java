...
//	    System.out.println("Validating customer with email: " + dto.getEmail());
//	    
...
//	    }
//	    
//	    // Validate credentials using the CustomerService
...
//	}
	...
	public ResponseEntity<?> validateCustomer(@RequestBody LoginDTO dto) {
	    ...
	    System.out.println("Received validation request with: " + dto);

	    // Check if email and password are not null
	    if (dto.getEmail() == null || dto.getEmail().trim().isEmpty() || dto.getPassword() == null) {
	        return Response.status(HttpStatus.BAD_REQUEST);
	    }
