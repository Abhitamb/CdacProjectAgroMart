...
import CounterUpAnimation from './components/CounterUp';
import Testimonial from './components/Testimonial';

import AddProdInformation from './static/AddProdInformation';
import GetProdInfo from './static/GetProdInfo';
import ContactTable from './static/GetContactInfo';


const initialOptions = {
  clientId: 'Ae8rrj0wjU9i9HtlCI3LUzXNzyTa6_l84wPuyZjXONvo1BYOqYU1xe7DrRHnCfYABgNjMlpjmRNj_-cW',
  currency: 'INR',
};
    ...
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/add-info" element={<AddProdInformation />} />
          <Route path="/getinfo" element={<GetProdInfo />} />
          <Route path="/getContactInfo" element={<ContactTable />} />
