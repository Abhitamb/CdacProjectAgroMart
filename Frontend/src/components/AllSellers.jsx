...
//   useEffect(() => {
//     axios.get("http://localhost:8081/api/sellers").then((resp) => {
...
//     if (response) {
//       axios.delete("http://localhost:8081/api/sellers/" + id).then((resp) => {
//         axios.get("http://localhost:8081/api/sellers").then((resp) => {
//           setSellers(resp.data.data);
//         });
//       });
...
function AllSellers() {
  ...
  const deleteSeller = (id) => {
    ...
    if (response) {
      axios.delete(`http://localhost:8081/api/sellers/${id}`).then(() => {
        axios.get("http://localhost:8081/api/sellers").then((resp) => {
          setSellers(resp.data.data);
        });
      });
