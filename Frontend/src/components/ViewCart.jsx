...
function ViewCart() {
    ...
    useEffect(() => {
        // Ensure payment amount is updated when cart changes
    }, [state.cart]);
                ...
                <div className="row">
                    ...
                    <div className="col-sm-4">
                        ...
                        <form>
                            ...
                            <h5 className="p-2 text-dark">Payment Information</h5>
                            <PayPalScriptProvider options={{ "client-id": "your-client-id", "currency": "INR" }}>
                                <PayPalButtons
                                    createOrder={async (data, actions) => {
                                        const response = await fetch('/api/payments/create-order?amount=' + totalAmount.toFixed(2), {
                                            method: 'POST'
                                        });
